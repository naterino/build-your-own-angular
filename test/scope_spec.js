...
describe('Scope', function(){
	...
	describe('digest', function(){
		...
		it('allows destrying a $watch with a removal function', function(){
			scope.aValue = 'abc';
			scope.counter = 0;
	...
	describe('$eval', function() {
		...
		it('executes $avaled function and returns result', function() {
			scope.aValue = 42;
	...
	describe('$apply', function() {
		...
		it('executes the given function and starts the digest', function() {
			...
			scope.$watch(
				...
				function(newValue, oldVale, scope) {
					scope.counter++;
				}
				);
	...
	describe('$evalAsync', function() {
		...
		it('executes given functions later in the same cycle', function() {
			scope.aValue = [1, 2, 3];
